...
import { DollarSign, Users, RefreshCw, ShoppingCart } from "lucide-react";
    ...
    return (
        <div className="flex flex-1 flex-col gap-8 p-4 pt-0">
            ...
            <Suspense fallback={<FinanceSkeleton />}>
                <FinanceContent startDate={startDate} endDate={endDate} />
            </Suspense>
        </div>
    );
}

async function FinanceContent({ startDate, endDate }: { startDate: string; endDate: string }) {
    console.log(`[Finance Page] 🔍 Filtro: start=${startDate}, end=${endDate}`);
...
function FinanceSkeleton() {
    return (
        <main className="space-y-8 w-full max-w-[1600px] mx-auto">
